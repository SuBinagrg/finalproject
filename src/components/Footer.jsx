...
const Footer = () => {
  ...
  return (
    <footer className="bg-background bg-black text-white border-t border-border/40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground mb-6 max-w-md">
              Learnly empowers you to grow your skills and unlock new
              opportunities. Discover expert-led courses, connect with
              instructors, and advance your career.
            </p>
            {/* Social links */}
