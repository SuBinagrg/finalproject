      ...
      >
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            type="text"
            id="title"
            className={`w-full rounded-md border px-4 py-3 shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition ${
              errors.title
        ...
        <div className="space-y-1">
          ...
          <select
            {...register("category")}
            id="category"
            className={`w-full rounded-md border px-4 py-3 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition ${
              errors.category
                ? "border-red-500 focus:ring-red-500 focus:border-red-500"
                : "border-gray-300"
            }`}
